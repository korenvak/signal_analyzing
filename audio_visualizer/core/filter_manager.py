...
FILTER_COMPATIBILITY: Dict[str, FilterCompatibility] = {
    ...
    'lowpass_filter': FilterCompatibility.SPECTROGRAM,
    'highpass_filter': FilterCompatibility.SPECTROGRAM,
    'bandpass_filter': FilterCompatibility.SPECTROGRAM,
    'bandstop_filter': FilterCompatibility.SPECTROGRAM,
    
    # We may re-add simple filters here later
}
...
# Removed KorenFilter import as it's being deleted
...
class FilterManager:
    ...
    # Removed apply_meijering and _meijering_gpu (Advanced feature)
    ...
    # Advanced filters removed (Horizontal/Vertical Line, Spectral Subtraction, PCEN, Morphological, Noise Gate)
